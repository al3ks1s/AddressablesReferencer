...
namespace AddressableReferencer.Editor.GUI { 
    ...
    public class AddressableReferencerMultiColumnHeader :MultiColumnHeader
    {
        ...
        public static MultiColumnHeaderState.Column[] GetColumns()
        {
            ...
            retVal[counter].headerContent = new GUIContent("Group \\ Bundle \\ Object Path", "The bundle location of the referenced object");
            ...
            retVal[counter].headerContent = new GUIContent("Object", "Object that will be referenced");
            retVal[counter].minWidth = 100;
            ...
            retVal[counter].headerContent = new GUIContent("Internal Path Id", "The bundle PathID that will be attributed to the object");
